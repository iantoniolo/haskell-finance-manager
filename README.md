...
Projeto da disciplina de **Programação Funcional** — desenvolvido em **Haskell puro**, executado pelo terminal.
...
O objetivo acadêmico é demonstrar, em um programa pequeno e legível, os principais
...
| **Recursão**                    | `somaValores`, `contar`, `maiorGasto`, `separarData`, `exibirTransacoes`, `imprimirCategorias`, `lerTexto`, `lerValor`, `lerData` e o próprio `loop` |
| **List comprehension**          | `despesas`, `buscarCategoria`, `categoriasDespesas`, `totalCategoria`                                                                                 |
...
| **Guards**                      | `mediaDespesas`, `maiorGasto`, `diasNoMes`, validação em `lerValor`                                                                                      |
